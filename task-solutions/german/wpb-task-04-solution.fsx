(**
// can't yet format YamlFrontmatter (["title: 04 Programming with functions"; "category: Musterlösungen(deutsch)"; "categoryindex: 1"; "index: 4"], Some { StartLine = 2 StartColumn = 0 EndLine = 6 EndColumn = 8 }) to pynb markdown
